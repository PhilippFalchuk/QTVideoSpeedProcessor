...
#include <memory>
#include "../../ImageTcpClient/tcpclientwindow.h"
...
QT_MOC_LITERAL(1, 16, 15), // "onImageRecieved"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 5) // "image"

    },
    "TcpClientWindow\0onImageRecieved\0\0image"
};
...
void TcpClientWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onImageRecieved((*reinterpret_cast< QImage(*)>(_a[1]))); break;
        default: ;
        }
    }
}
